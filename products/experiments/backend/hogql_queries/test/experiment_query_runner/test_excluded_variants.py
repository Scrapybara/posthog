...
def test_fingerprint_changes_when_baseline_variant_changes():
    ...
    fp_default = compute_metric_fingerprint(metric, start, baseline_variant_key=None)
    ...
    assert fp_default == compute_metric_fingerprint(metric, start)
    assert fp_control != fp_default
    assert fp_test != fp_control
